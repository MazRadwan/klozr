  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      <aside
        ref={sidebarRef}
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex flex-col h-screen bg-white/20 dark:bg-slate-900/40 shadow-xl border-r border-white/10 dark:border-slate-800/30 backdrop-blur-lg transition-all duration-300 overflow-hidden",
          "group/sidebar",
      ...
      >
        <div className="flex h-16 items-center px-4 border-b border-gray-200 dark:border-gray-700 transition-all duration-300">
        ...
        <nav className="flex flex-col gap-1 px-2 py-6">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 rounded-lg px-3 py-2 my-1 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors"
          >
            <span className="inline-block w-6"><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-layout-dashboard"><rect x="3" y="3" width="7" height="9" rx="1"/><rect x="14" y="3" width="7" height="5" rx="1"/><rect x="14" y="12" width="7" height="9" rx="1"/><rect x="3" y="16" width="7" height="5" rx="1"/></svg></span>
          ...
          <Link
            ...
            className="flex items-center gap-3 rounded-lg px-3 py-2 my-1 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors"
          >
            <span className="inline-block w-6"><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-kanban"><rect x="2" y="2" width="20" height="20" rx="2.18"/><path d="M6 6v8"/><path d="M12 6v4"/><path d="M18 6v12"/></svg></span>
          ...
          >
            <span className="inline-block w-6"><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-log-out"><path d="M9 16l-4-4 4-4"/><path d="M5 12h12"/><path d="M17 16v1a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v1"/></svg></span>
